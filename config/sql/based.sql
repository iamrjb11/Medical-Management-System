...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2017 at 07:31 PM
...
CREATE TABLE `med_prescribed_medicines` (
  ...
  `medicine_name` varchar(100) NOT NULL,
  `before_eat` varchar(100) DEFAULT NULL,
  `after_eat` varchar(100) DEFAULT NULL,
...
INSERT INTO `med_prescribed_medicines` (`srl_no`, `prescription_id`, `medicine_name`, `before_eat`, `after_eat`, `quantity`, `given_quantity`) VALUES
(1, 1, 'Napa', '0-0-0', '1-0-1', 20, 5),
(2, 1, 'Maxpro 20mg', '1-0-1', '0-0-0', 30, 10),
(3, 1, 'Deslor', '0-0-0', '1-0-1', 10, 3),
(6, 2, 'Napa 2', '0-0-0', '1-0-1', 20, NULL),
(7, 2, 'Maxpro 40mg 2', '1-0-1', '0-0-0', 30, NULL);
...
(1, 'hasib@d.com', 'imran@p.com', '11/04/2017'),
(2, 'faria@d.com', 'imran@p.com', '11/04/2017');
...
(46, 'faria@d.com', 'imran@p.com', 'Sat', '11/04/2017'),
(47, 'faria@d.com', 'imran@p.com', 'Sun', '11/05/2017'),
(48, 'hasib@d.com', 'imran@p.com', 'Sat', '11/04/2017'),
(49, 'hasib@d.com', 'imran@p.com', 'Sun', '11/05/2017'),
(50, 'faria@d.com', 'tan@p.com', 'Sat', '11/04/2017'),
(51, 'faria@d.com', 'tan@p.com', 'Sun', '11/05/2017'),
(52, 'hasib@d.com', 'tan@p.com', 'Sat', '11/04/2017'),
(53, 'hasib@d.com', 'tan@p.com', 'Sun', '11/05/2017'),
(54, 'r@d.com', 'tan@p.com', 'Sun', '11/05/2017');
...
(1, 1, 'Blood Test', 'shumi@n.com', 'imran@p.com+Blood Test+1.PNG');
...
('aysha@d.com', '021478', 'aysha@d.com', '123', 'Dr. Aysha', 'Khatun', 42, 'Female', 'MBBS', 'Heart Specialist', 'Khulna University', 'Sun Web Thu', '5pm-8pm', 'approved', NULL, NULL, NULL),
...
('hasib@d.com', '0210', 'hasib@d.com', '123', 'Dr. Hasib', 'Uddin', 54, 'Male', 'MBBS', 'Heart Specialist', 'Khulna University', 'Sat Tue Fri', '8pm-10pm', 'approved', NULL, NULL, NULL),
...
('rajib@p.com', '150288', 'rajib@p.com', '123', 'Rajib', 'Khan', 24, 'Male', '', '', '', '', '', 'approved', NULL, NULL, NULL),
...
('sumon@p.com', '150287', 'sumon@p.com', '123', 'Sumon', 'Hasan', 25, 'Male', '', '', '', '', '', 'approved', NULL, NULL, NULL),
...
(129, 'rajib@p.com', 'Patient'),
(130, 'sumon@p.com', 'Patient');
...
--
ALTER TABLE `med_prescribed_medicines`
  MODIFY `srl_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `med_serial`
--
ALTER TABLE `med_serial`
  MODIFY `serial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `med_tests`
--
ALTER TABLE `med_tests`
  MODIFY `srl_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
